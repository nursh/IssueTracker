...
class SignIn extends Component {
  render() {
    return (
      <>
        <div className="mt-12 max-w-lg m-auto bg-white shadow-lg rounded px-8 py-10">
        ...
        <div className="mt-10 max-w-lg m-auto bg-gray-300 rounded text-center py-4">
          ...
          <NavLink to="/signup" className="ml-3 font-semibold hover:underline">Sign up</NavLink>
        </div>
      </>
    );
  }
